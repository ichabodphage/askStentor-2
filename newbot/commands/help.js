...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('help')
        .setDescription('displays a help menu for the commands')
        .addStringOption(option => option.setName('command').setDescription('command to show information about')),
    async execute(interaction) {
        ...
        await interaction.reply({ embeds: [describeEmbead] })
    },
};